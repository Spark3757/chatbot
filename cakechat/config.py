...
USE_PRETRAINED_W2V_EMBEDDINGS_LAYER = False  # Whether to use word2vec to pre-train weights for the embedding layer
...
SCREEN_LOG_FREQUENCY_PER_BATCHES = 250  # How many batches to train until next logging of output on screen
